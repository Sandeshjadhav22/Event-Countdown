...
import { CountdowmTimer } from "@/components/countdown-timer";
      ...
      <div className="max-w-7xl mt-20 mx-auto">
        <div className="flex flex-col items-center relative z-10">
          <h1 className={`text-5xl max-w-3xl text-center leading-snug mb-12 ${poppins.className}`}>
            <Image
            alt="Figma logo"
            className="inline-block mr-8 -mt2"
            src={assets.figma}
            width="50"
            height="50"
            />
          ...
          <p className="mb-8">
            <span className="text-gray-300">Join us for AI launch event by{" "}</span>
            <Image
            alt="Builder.io logo"
          ...
          <div className="mb-8">
            <button ref={buttonRef} className={cn(" text-black px-6 py-3 rounded-md text-sm font-semibold transition-colors duration-200",
            {
              "bg-purple-300": currentFramework === "qwik",
              "bg-sky-300": currentFramework === "safari",
              "bg-yellow-300": currentFramework === "chrome",
          ...
          <CountdowmTimer currentFramework={currentFramework} />
        </div>
      </div>
